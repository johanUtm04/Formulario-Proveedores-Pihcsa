...
if ($row = mysqli_fetch_assoc($res)) {
    ...
    echo json_encode([
        ...
        'archivos' => [
            ...
            'doc_opinion_cumplimiento'        => !empty($row['doc_opinion_cumplimiento']),
            'doc_caratula_bancaria'           => !empty($row['doc_caratula_bancaria']),
            ...
            'doc_hoja_seguridad_producto'     => !empty($row['doc_hoja_seguridad_producto']),
            ...
            'img_placa_responsable'           => !empty($row['img_placa_responsable']),
